...
from core import (
    ADMIN_ID, MAIN_CHANNEL_URL, get_db, get_session, init_db,
    register_user, save_file, search_files, send_msg, send_pic,
    set_session, send_media_group, get_next_sequence_value
)
...
def kb_khab():
    return {"keyboard": [[{"text": "۱ خواب"}, {"text": "۲ خواب"}], [{"text": "۳ خواب"}, {"text": "۴ خواب و بیشتر"}], [{"text": "بازگشت به منو اصلی"}]], "resize_keyboard": True}

def kb_budje_forosh():
    return {"keyboard": [[{"text": "۲۰ تا ۳۰ میلیارد"}, {"text": "۳۰ تا ۴۰ میلیارد"}], [{"text": "۴۰ تا ۵۰ میلیارد"}, {"text": "۵۰ میلیارد به بالا"}], [{"text": "بازگشت به منو اصلی"}]], "resize_keyboard": True}

def kb_budje_rahn():
    return {"keyboard": [[{"text": "کمتر از ۲ میلیارد"}, {"text": "۲ تا ۴ میلیارد"}], [{"text": "۴ تا ۶ میلیارد"}, {"text": "۶ میلیارد به بالا"}], [{"text": "بازگشت به منو اصلی"}]], "resize_keyboard": True}

def kb_meter():
    return {"keyboard": [[{"text": "کمتر از ۱۰۰ متر"}, {"text": "۱۰۰ تا ۱۵۰ متر"}], [{"text": "۱۵۰ تا ۲۰۰ متر"}, {"text": "بیشتر از ۲۰۰ متر"}], [{"text": "بازگشت به منو اصلی"}]], "resize_keyboard": True}
